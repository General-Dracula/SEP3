...
public class Tier1ApiConnection {
    ...
    @GetMapping("/secretary/changeusername")
    public ResponseEntity<String> changeusername(@RequestParam String newUsername)
    {
        System.out.println("AJUNGE DELETE STUDENT");
        NetworkPackage networkPackage = model.changeSecretaryUsername(newUsername);
        String response = gson.toJson(networkPackage);
        if (networkPackage.getType().equals(NetworkType.SecretaryError)) {
            System.out.println("BAD REQUEST");
            return new ResponseEntity<String>(HttpStatus.BAD_REQUEST);
    ...
    @GetMapping("/secretary/changepassword")
    public ResponseEntity<String> changepassword(@RequestParam String newPassword)
    {
        System.out.println("AJUNGE DELETE STUDENT");
        NetworkPackage networkPackage = model.changeSecretaryPassword(newPassword);
        String response = gson.toJson(networkPackage);
        if (networkPackage.getType().equals(NetworkType.SecretaryError)) {
            System.out.println("BAD REQUEST");
            return new ResponseEntity<String>(HttpStatus.BAD_REQUEST);
